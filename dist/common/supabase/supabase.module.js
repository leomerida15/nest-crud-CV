...
SupabaseModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [supabase_1.Supabase, supabase_strategy_1.SupabaseStrategy, supabase_guard_1.SupabaseGuard],
        exports: [supabase_1.Supabase, supabase_strategy_1.SupabaseStrategy, supabase_guard_1.SupabaseGuard],
    })
], SupabaseModule);
